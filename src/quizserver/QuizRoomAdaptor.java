...
public class QuizRoomAdaptor extends BaseRoomAdaptor {
    ...
    private byte QUIZ_TYPE = QuizType.SIXTIES;
    ...
    public QuizRoomAdaptor(IZone izone, IRoom room) {
        ...
        try {
            if (((Room) this.gameRoom).getProperties().get("QuizTopic").toString().equalsIgnoreCase("Sixties")) {
                QUIZ_TYPE = QuizType.SIXTIES;
System.out.println("SIXTIES");
            } 

if (((Room) this.gameRoom).getProperties().get("QuizTopic").toString().equalsIgnoreCase("Seventies")){
                QUIZ_TYPE = QuizType.SEVENTIES;
System.out.println("SEVENTIES");}
            



if (((Room) this.gameRoom).getProperties().get("QuizTopic").toString().equalsIgnoreCase("Eighties")){
                QUIZ_TYPE = QuizType.EIGHTIES;
System.out.println("EIGHTIES");}
            


if (((Room) this.gameRoom).getProperties().get("QuizTopic").toString().equalsIgnoreCase("Nineties")){
                QUIZ_TYPE = QuizType.NINETIES;
System.out.println("NINETIES");}
            


if (((Room) this.gameRoom).getProperties().get("QuizTopic").toString().equalsIgnoreCase("Noughties")){
                QUIZ_TYPE = QuizType.NOUGHTIES;
System.out.println("NOUGHTIES");}
